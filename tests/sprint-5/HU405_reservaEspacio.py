...
class reservaEspacio(unittest.TestCase):
    ...
    def test_reservaEspacio(self):
        ...
        time.sleep(2)
        reservedField = driver.find_element(By.XPATH, "/html/body/app-root/div/app-deporte-seleccionado/div/div/div/div[3]/div[3]/table/tbody/tr[6]/td[2]/div[3]/div[1]/button/span[2]/div")
        reservedField.click()
