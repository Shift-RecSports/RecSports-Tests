...
class visualizarAnuncios(unittest.TestCase):
    ...
    def test_visualizarAnuncios(self):
        driver = self.driver
        ...
        tarjetaAnuncios = driver.find_element(By.XPATH, "/html/body/app-root/div/app-home/div/div/div[2]/div[1]/div/app-news/nz-carousel/div/div/div/div[1]")
        assert tarjetaAnuncios.is_displayed()
        print("🟢 Anuncios de RecSports y LiFE se visualizan correctamente")
