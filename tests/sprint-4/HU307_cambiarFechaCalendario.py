...
#HU307
#Comprobar accesibilidad y visualización apropiada de 
# la oferta de espacios deportivos y sus correspondientes 
# horarios en múltiples días de la semana actual.

class cambiarFecha(unittest.TestCase):
