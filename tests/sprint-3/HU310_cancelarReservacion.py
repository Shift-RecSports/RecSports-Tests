...
class LoginPageTest(unittest.TestCase):
    ...
    def test_adminLogin(self):
        ...
        #Validar reservaciones existents
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-reservaciones/div/div/div/div/div[2]/div[2]").text, "17 junio 2023")
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-reservaciones/div/div/div/div/div[2]/div[3]").text, "11:00 - 12:00")
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-reservaciones/div/div/div/div/div[3]/div[2]").text, "Baloncesto")
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-reservaciones/div/div/div/div/div[3]/div[3]").text, "CBD1")
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-reservaciones/div/div/div/div/div[3]/div[4]").text, "Cancha 2")
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-reservaciones/div/div/div/div/div[5]/div[2]").text, "Balón y tennis de baloncesto")
        ...
        print("🟢 RESERVA ELIMINADA OK")

        #Navegar a deportes
        navegarDeportes = driver.find_element(By.XPATH, "/html/body/app-root/app-sidebar/mat-sidenav-container/mat-sidenav/div/mat-nav-list/div[2]/a/span/span/div/span")
        navegarDeportes.click()
        time.sleep(2)
        ...
        #Validar que la reservacion cancelada ahora aparezca disponible
        self.assertEqual(driver.find_element(By.XPATH, "/html/body/app-root/div/app-deporte-seleccionado/div/div/div/div[3]/div[3]/table/tbody/tr[6]/td[2]/div[3]/div[1]/button/span[2]/div").text, "Cancha 2")
        print("🟢 HORARIO DE RESERVACION DISPONIBLE OK")
