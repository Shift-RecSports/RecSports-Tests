...
#HU104
# verificar que cada botón redireccione al 
# usuario a donde debería y los botones correspondan 
# a sus credenciales

class BarraVerticalTest(unittest.TestCase):
    ...
    def test_barraVerticalUser(self):
        driver = self.driver
        ...
        assert driver.find_element(By.XPATH, "/html/body/app-root/app-sidebar/mat-sidenav-container/mat-sidenav")    
        print("🟢 Barra Vertical OK")

    def test_barraVerticalAdmin(self):
        driver = self.driver
    ...
    def test_barraVerticalEntrenador(self):
        driver = self.driver
